...
class Manager {
  ...
  fire(employee) {
    return this.reports.splice(this.reports.indexOf(employee) - 1, 1);
  }
}
...
class Machine {
  ...
  makeWidgets(numWidgets) {
    this.widgets_made_count += numWidgets;
    let wearNTear = numWidgets / 50;
    this.wear_and_tear_count += wearNTear;
  }
